...
public class ScriptTestsSpecification extends ServerCoreSpecification implements CoreGroovyTrait
{
    def setupSpec()
    {
        setupServerCoreDefault(ScriptTestsSpecification,
    ...
    {
        setup:
        def lang = scripting().getScriptEngineManager().getEngineFactories().collect { ScriptEngineFactory fact ->

            [(fact.getEngineName()) : fact.getExtensions()]
        }
        echo json(extn: lang)
