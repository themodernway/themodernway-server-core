...
public class RedirectResponseAction extends StatusCodeResponseAction
{
    private final String m_path;

    public RedirectResponseAction(final String path)
    {
        this(HttpServletResponse.SC_MOVED_TEMPORARILY, path);
    }

    protected RedirectResponseAction(final int code, final String path)
    {
        super(code);
    ...
    {
        return new RedirectResponseAction(getStatusCode(), getPath()).withSupplier(headers);
    }
}
